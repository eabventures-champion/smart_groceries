...
<div class="container mb-30">
   <article class="card">
      ...
      <div class="card-body">
         <h6 class="mb-10">Tracking Number : {{ $track->invoice_no }} </h6>
         <article class="card">
            <div class="card-body row">
               <div class="col"> <strong>Order Date:</strong> <br>{{ $track->order_date }} </div>
               <div class="col"> <strong>Sending To:</strong> <br> {{ $track->name }} | <i class="fa fa-phone"></i> {{ $track->phone }} <br> {{ $track->region->region_name }} / {{ $track->district->district_name }} / {{ $track->city->city }}   </div>
               {{-- <div class="col"> <strong>Payment Method:</strong> <br>{{ $track->payment_method }} </div> --}}
               <div class="col"> <strong>Total Amount #:</strong> <br>Gh {{ $track->amount }}</div>
            </div>
         </article>
         <div class="track">
