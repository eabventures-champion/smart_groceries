                     ...
                     <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                        <div class="card">
                           <div class="card-header text-center-dashboard">
                              <h3>Account Details<span><i class="fi-rs-user pl-15"></i></span></h3>
                           </div>
                           <div class="card-body">
                              <form method="post" action="{{ route('user.profile.update') }}" enctype="multipart/form-data" >
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                       <label>User Photo (Optional)</label>
                                       <input class="form-control" name="photo" type="file"  id="image" />
                                    </div>
                                    <div class="form-group col-md-12">
                                       <label>  <span class="required"></span></label>
                                       <img id="showImage" src="{{ (!empty($userData->photo)) ? url('front/assets/imgs/users/'.$userData->photo):url('front/assets/imgs/users/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
                                    </div>
                                    <div class="col-md-12">
