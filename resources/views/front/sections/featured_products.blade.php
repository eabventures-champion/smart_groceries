@php
    $featured = App\Models\Product::where(['featured' => 1, 'status' => 1])->orderBy('id', 'DESC')->limit(6)->get();
@endphp
    ...
    <section class="section-padding d-block d-lg-none">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                {{-- <div class="col-lg-3 col-md-6 d-block d-lg-block wow animate__animated animate__fadeIn"> --}}
                    <div class="banner-img style-2">
                        <div class="banner-text">
                            <h2 class="mb-100">From the store to your home</h2>
