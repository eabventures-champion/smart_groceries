               ...
               <h5 class="mb-30">Billing Details (kindly fill all fields)</h5>
                  <div class="row">
                    <div class="form-group col-lg-6">
                     ...
                     <div class="form-group col-lg-6 d-block d-lg-none">
                  ...
                  <div class="row shipping_calculator">
                     ...
                     <div class="form-group col-lg-6 d-none d-lg-block">
                        <input required type="text" name="delivery_phone" value="{{ Auth::user()->phone }}" placeholder="Phone">
                     </div>
                  </div>
                  <div class="row shipping_calculator">
                     <div class="form-group col-lg-6">
                        <span style="color: red">(Select the Region first, then click here to select your choice school in the list)</span>
                        <div class="custom_select">
                  ...
                  <div class="row shipping_calculator">
                     <div class="form-group col-lg-6">
                        <span style="color: red">(Click here to select your choice house in the list <br> NB: The Region must be selected first)</span>
                        <div class="custom_select">
                           <select required class="form-control" name="city_id"></select>
                        </div>
                     </div>
                     {{-- <div class="form-group col-lg-6">
                        <input required="" type="text" name="delivery_address" value="{{ Auth::user()->address }}">
                     </div> --}}
                  </div>
                  <div class="form-group mb-30">
                     <textarea style="min-height: 100px;" rows="5" placeholder="Additional information (Optional)" name="notes"></textarea>
                  </div>
            </div>
         </div>
         <div class="col-lg-7">
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <div class="product-rate-cover">
                                 <strong>Variant :{{ $item->options->color }} </strong>
...
<script type="text/javascript">
   $(document).ready(function(){
       $('select[name="region_id"]').on('change', function(){
           ...
           if (region_id) {
               $.ajax({
                   url: "{{ url('/district-get/ajax') }}/"+region_id,
                   type: "GET",
                   dataType:"json",
