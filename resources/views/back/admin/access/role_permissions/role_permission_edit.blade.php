      ...
      <div class="ps-3">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
               <li class="breadcrumb-item"><a href="{{ route('all.roles.permission') }}"><i class="bx bx-home-alt">&nbsp;Back</i></a>
               </li>
      ...
      <div class="main-body">
         <div class="row">
            <div class="col-lg-10">
               <div class="card">
                  <div class="card-body">
                    <form id="myForm" method="post" action="{{ route('admin.roles.permission.update', $role->id) }}"  >
                        @csrf
                        <div class="row mb-3">
                           <div class="col-sm-3">
                        ...
                        <div class="row">
                           ...
                           <div class="col-9">
                              ...
                              <div class="form-check">
                                 <input class="form-check-input" name="permission[]" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}  type="checkbox" value="{{ $permission->name }}" id="flexCheckDefault{{ $permission->name }}">
                                 <label class="form-check-label" for="flexCheckDefault{{ $permission->name }}">{{ $permission->name }}</label>
                              </div>
                              @endforeach
                              <br>
                           </div>
