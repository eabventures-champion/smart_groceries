      ...
      <div class="ps-3">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
               <li class="breadcrumb-item"><a href="{{ route('all.admin') }}"><i class="bx bx-home-alt">&nbsp;Back</i></a>
               </li>
                  ...
                  <div class="card-body">
                     <form method="post" action="{{ route('admin.user.store') }}">
                        ...
                        <div class="row mb-3">
                           ...
                           <div class="col-sm-9 text-secondary">
                              <input type="text" name="phone" class="form-control" placeholder="e.g. 0243036092" pattern="[0-9]{10}" maxlength="10" minlength="10" inputmode="numeric" title="Phone number must be exactly 10 digits (e.g. 0243036092)" />
                           </div>
                        </div>
                        <div class="row mb-3">
                           <div class="col-sm-3">
