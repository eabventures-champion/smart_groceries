      ...
      <div class="main-body">
         <div class="row">
            <div class="col-lg-10">
               <div class="card">
                  <div class="card-body">
                     <form id="myForm" method="post" action="{{ route('update.hall') }}"   >
                        @csrf
                        ...
                        <div class="row mb-3">
                           ...
                           <div class="form-group col-sm-9 text-secondary">
                              <select name="region_id" class="form-select mb-3" aria-label="Default select example">
                                 ...
                                 <option value="{{ $item->id }}" {{ $item->id == $city->region_id ? 'selected' : ''  }}>{{ $item->region_name }}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        ...
                        <div class="row mb-3">
                           ...
                           <div class="form-group col-sm-9 text-secondary">
                              <input type="text" name="city_name" class="form-control"  value="{{ $city->city }}" />
                           </div>
                        </div>
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('select[name="region_id"]').on('change', function(){
            ...
            if (region_id) {
                $.ajax({
                    url: "{{ url('/admin/district/ajax') }}/"+region_id,
                    type: "GET",
                    dataType:"json",
