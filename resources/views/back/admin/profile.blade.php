               ...
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex flex-column align-items-center text-center">
                        <img src="{{ (!empty($profile->photo)) ? url('back/assets/images/admin/'.$profile->photo) : url('back/assets/images/admin/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                        <div class="mt-3">
                    ...
                    <form method="POST" action="{{ route('admin.profile.update') }}" class="forms-sample" enctype="multipart/form-data">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                           <input type="text" name="username" value="{{ $profile->username }}" class="form-control" readonly />
                        </div>
                     </div>
                     <div class="row mb-3">
                        <div class="col-sm-3">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="phone" value="{{ $profile->phone }}" class="form-control" placeholder="e.g. 0243036092" pattern="[0-9]{10}" maxlength="10" minlength="10" inputmode="numeric" title="Phone number must be exactly 10 digits (e.g. 0243036092)" />
                        </div>
                     </div>
                     <div class="row mb-3">
                        <div class="col-sm-3">
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="file" name="photo" class="form-control" value="{{ $profile->photo }}" id="image">
                        </div>
                     </div>
                     <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profile->photo)) ? url('back/assets/images/admin/'.$profile->photo) : url('back/assets/images/admin/no_image.jpg') }}" alt="profile" style="width: 100px; height: 100px">
                        </div>
                     </div>
                     <div class="row">
