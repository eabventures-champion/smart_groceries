      ...
      <div class="main-body">
         <div class="row">
            <div class="col-lg-10">
               <div class="card">
                  <div class="card-body">
                    <form id="myForm" method="POST" action="{{ route('update.category') }}" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                     ...
                     <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <img id="showImage" class="wd-80 rounded-circle" src="{{ asset($category->category_photo) }}" alt="profile" style="width: 100px; height: 100px">
                        </div>
                     </div>
                     <div class="row">
